{
  let view = {
    el: '.uploadArea',
    find(selector) {
      console.log($(this.el), selector, $(this.el).find(selector))
  ...
  let controller = {
    ...
    initQiniu() {
      ...
      var uploader = Qiniu.uploader({
        ...
        domain: 'pso79y2d5.bkt.clouddn.com',   //bucket 域名，下载资源时用到，**必需**
        get_new_uptoken: false,  //设置上传文件的时候是否每次都重新获取新的token
        max_file_size: '9mb',           //最大文件体积限制
